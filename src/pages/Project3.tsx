        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }} className="learning-items">
            {[
              ...
              {
                number: "05",
                heading: "The Name, The Mascot are part of the UX.",
                body: "We didn't name it Marga for marketing. It was a trust decision with a purpose. Rural users needed to feel guided by a person - not processed by a machine.",
              },
            ].map((item, index) => (
              <div
                key={item.number}
